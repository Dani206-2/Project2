...
## Inputs: n: the number of prisoners divided by 2, k: the prisoner through 
...
## intuitively the probability for strategy 2 is <1/2. 

## The really surprising result comes when we consider the probability of 
## success for all the prisoners combined. For strategies 2,3 the probabilities
## of every prisoner are independent, because of the random choice of boxes,
## which makes the combined probability fall off to zero really fast as the 
## number of prisoners increases. For strategy 1, we get a very high probability 
## compared to the other strategies, because the individual probabilities of 
## success are no longer independent. To see this, take into account the 
## underlying permutation of boxes, if for example prisoner 1 finds their
